  ...
  return (
    <div className=" ">
      <div className="flex flex-col items-center gap-[20px]">
        <ReactCardFlip
          isFlipped={isFlipped}
          flipDirection="horzintal"
          flipSpeedBackToFront="0.4"
          flipSpeedFrontToBack="0.4"
        >
          <div className="bg-[#C0C0C0] w-[360px] h-[210px] mt-[50px] p-[10px] rounded-lg">
          ...
          <div className="bg-[#C0C0C0] w-[360px] h-[210px] mt-[50px] rounded-lg">
        ...
        <button
          className="text-black text-[16px] font-mono font-bold bg-[#C0C0C0] rounded-lg border-[2px] border-[#C0C0C0] p-[4px] hover:border-[#9264F3]"
          onClick={handleClick}
        >
          {" "}
          FLIP{" "}

  ...
  return (
    <div className=" ">
      <div className="flex flex-col items-center gap-[20px]">
        ...
        >
          <div className="bg-[#7851A9] w-[360px] h-[210px] mt-[50px] p-[10px] rounded-lg">
            <div className="flex gap-[10px]">
              {/*Name and Picture */}
              <div className="flex flex-col basis-1/2 text-white justify-center gap-[10px]">
                <img
                  src={avatar}
                  alt=""
          ...
          <div className="bg-[#7851A9] w-[360px] h-[210px] mt-[50px] rounded-lg">
        ...
        <button
          className="text-white text-[16px] font-mono font-bold bg-[#7851A9] rounded-lg border-[2px] border-[#7851A9] p-[4px] hover:border-[#9264F3]"
          onClick={handleClick}
        >
          {" "}
          FLIP{" "}
...
export default RoyalPurpleCard;
